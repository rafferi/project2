                        ...
                        @if($userFavorites->contains($prod->id))
                            <form action="{{ route('favorites.destroy', $prod->id) }}" method="post" class="favorite-form">
                                ...
                                <button type="submit" class="favorite-btn" title="Убрать из избранного">
                                    <img src="{{ asset('images/icons/like.png') }}" alt="Убрать из избранного" class="favorite-icon">
                                </button>
                            </form>
                        @else
                            <form action="{{ route('favorites.store', $prod->id) }}" method="post" class="favorite-form">
                                @csrf
